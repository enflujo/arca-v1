...
function initSigma(config) {
  ...
  if (config.sigma && config.sigma.graphProperties) graphProps = config.sigma.graphProperties;
  else
    graphProps = {
      minNodeSize: 1,
      maxNodeSize: 7,
...
function showGroups(a) {
  a
    ? ($GP.intro.find('#showGroups').text('Hide groups'), $GP.bg.show(), $GP.bg2.hide(), ($GP.showgroup = !0))
