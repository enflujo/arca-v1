    ...
    /** @lends <global> */ function ($) {
      ...
      function _fnAddOptionsHtml(oSettings) {
        ...
        oSettings.nTableWrapper = $(
          '<div id="' + oSettings.sTableId + '_wrapper" class="' + oSettings.oClasses.sWrapper + '" role="grid"></div>'
        )[0];
            ...
            $(_div, { class: classes.sScrollFoot })
              ...
              .append(
                $(_div, { class: classes.sScrollFootInner }).append(
                  footerClone.removeAttr('id').css('margin-left', 0).append(table.children('tfoot'))
                )
              )
